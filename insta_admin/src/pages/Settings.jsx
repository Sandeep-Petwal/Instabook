import { Bolt, Fingerprint, Info, Laptop, LogOutIcon } from "lucide-react";
import { Link } from "react-router-dom";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import DeleteAcc from "../components/modals/DeleteAcc";
        ...
        <Card className="bg-gray-900 border-gray-800">
          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              ...
              <div className="group relative transition-all duration-200 hover:translate-x-1">
                <Link
