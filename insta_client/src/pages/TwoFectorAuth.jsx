...
import { Shield, KeyRound, Smartphone, AlertCircle, Loader2, Copy, Check } from 'lucide-react';
...
function TwoFactorAuth() {
    const { two_factor_enabled, user, set_Two_factor_enabled } = useInstaContext();
