...
import { Image, Send, Check, Loader2, X, Download, Info, CheckCircle } from 'lucide-react';
import { SocketContext } from '@/context/socketContext';

const SUPPORT_ADMIN_USER_ID = import.meta.env.VITE_SUPPORT_ADMIN_USER_ID;

const Chat = ({ issue, issue_id, user_id }) => {
    ...
    const handleImageChange = (e) => {
        ...
        // file size should be less than 1MB and should be an image
        if (file) {
    ...
    const handleSend = async () => {
        ...
        formData.append('receiver_id', SUPPORT_ADMIN_USER_ID);
        ...
        try {
            ...
            emitSupportMessage(response.data.data);
            // setConversations(prev => [...prev, response.data.data]); // NOTE: Not adding send message to conversation becaouse it will be added by socket
            setMessage('');
            setImage(null);
            setPreviewUrl('');
        } catch (error) {
    ...
    return (
        <div className="flex flex-col h-[600px] w-full bg-white dark:bg-gray-800 rounded-lg shadow-xl">
            <div className="p-4 border-b dark:border-gray-700 flex items-center justify-between">
                <div className="flex items-center">
                    <Avatar className="w-10 h-10 mr-3">
                        <AvatarImage src="/support.webp" alt="Support Agent" />
                        <AvatarFallback>SA</AvatarFallback>
                    </Avatar>
                    <div>
                        <h2 className="text-xl font-semibold">Support Agent</h2>
