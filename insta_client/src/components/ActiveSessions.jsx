...
function ActiveSessions() {
  ...
  const deleteAllSessions = async () => {
    const currentSessionId = sessions.find((session) => session.current)?.session_id;
    try {
  ...
  const getBrowserIcon = (userAgent) => {
    if (userAgent.includes("Chrome")) return <Chrome className="h-4 w-4 mr-2" />;
    if (userAgent.includes("Firefox")) return <Firefox className="h-4 w-4 mr-2" />;
    if (userAgent.includes("Safari")) return <Safari className="h-4 w-4 mr-2" />;
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action cannot be undone. This will permanently delete all other active sessions.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
